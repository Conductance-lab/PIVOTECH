支持demo检测的I2C测试界面，包含频率选择、DEMO选择、I2C监视器等功能
旧版本分支，新版本已经将DEMO移动到工具页
...
// // 选项：0=SCL/SDA交换, 1=频率（左2/3），2=DEMO（右1/3），3=I2C Monitor，4=SSD1306窗口，5=MPU6050窗口
...
// // 第三行右：DEMO 选择
// static int i2ctest_demo_selection_index = 0; // 0=SSD1306, 1=MPU6050（避免重名）

// // 外部窗口绘制接口（在此文件实现，避免链接缺失）
// void draw_ssd1306_testinfo();
// void draw_mpu6050_testinfo();
...
//     // 一次性高亮
//     // if (I2CWriteReady || I2CReadReady)
//     // {
//     //     InvertRect(buf, 0, Ypos + 0, 64, 16);
//     //     InvertRect(buf, 64, Ypos + 0, 64, 16);
//     // }
//     // I2CWriteReady = false;
//     // I2CReadReady = false;
...
//     Paint_DrawString_EN_CenterAtX(buf, 106, Ypos + 35, "演示", &Font12, 1);
...
// // 绘制 DEMO 选择窗口
// static void draw_i2ctest_demo_selector()
// {
//     int heigh = i2ctest_item_height * 3;
//     int width = i2ctest_ChangeVal_Width;
//     int x = (SCREEN_WIDTH - width) / 2;
//     int y = (SCREEN_HEIGHT - heigh) / 2 + 1;

//     UIDisplayStr_font12(x + 3, y + i2ctest_itemHeightOffset, "演示对象:", 16, 0);
//     if (i2ctest_demo_selection_index == 0)
//     {
//         UIDisplayStr_font12(x + 3, y + 1 * i2ctest_item_height + i2ctest_itemHeightOffset, ">SSD1306", 10, 0);
//         UIDisplayStr_font12(x + 3, y + 2 * i2ctest_item_height + i2ctest_itemHeightOffset, " MPU6050", 10, 0);
//     }
//     else
//     {
//         UIDisplayStr_font12(x + 3, y + 1 * i2ctest_item_height + i2ctest_itemHeightOffset, " SSD1306", 10, 0);
...
//     else
//         snprintf(freq_str, sizeof(freq_str), "%d", (int)i2c_freq);

//     snprintf(info, sizeof(info), "I2C:%sHz", freq_str);

//     int32_t rate = get_screen_refresh_rate();

//     if (rate == -1 && device_init_success)
//     {
//         snprintf(fps_str, sizeof(fps_str), "测试中");
//     }
//     else if (rate == 0 && device_init_success)
//     {
//         snprintf(fps_str, sizeof(fps_str), "设备错误");
//     }

//     else if (device_init_success)
//     {

//         snprintf(fps_str, sizeof(fps_str), "%luFPS", rate);
//     }
//     else if (!device_init_success && !device_error_occurred)
//     {
//         snprintf(fps_str, sizeof(fps_str), "无0x3C设备");
//     }
//     else if (device_error_occurred)
//     {
//         snprintf(fps_str, sizeof(fps_str), "设备错误");
//     }

//     UIDisplayStr_font12(x + 3, y + i2ctest_itemHeightOffset, info, 12, 0);
//     UIDisplayStr_font12(x + 3, y + 1 * i2ctest_item_height + i2ctest_itemHeightOffset, fps_str, 10, 0);
// }

// // 绘制 MPU6050 测试信息窗口
// void draw_mpu6050_testinfo()
// {
//     int heigh = i2ctest_item_height * 4;
//     int width = 120;
//     int x = (SCREEN_WIDTH - width) / 2;
//     int y = (SCREEN_HEIGHT - heigh) / 2 + 1;
...
//     char info[24];
//     char sps_str[20];
//     char data1[10], data2[10], data3[10], data4[10], data5[10], data6[10], temp[12];
//     char nodev[20] = "无0x68设备";
//     char nerrdev[20] = "设备错误";
//     char fuddev[20] = "测试中";
...
//     snprintf(info, sizeof(info), "I2C:%sHz", freq_str);
//     Paint_DrawString_EN(buf, x + 3, y + i2ctest_itemHeightOffset, info, &Font12, 1);

//     int32_t rate = get_screen_refresh_rate();

//     // rate = 0; // 测试代码，强制显示错误
//     if (rate == 0 && device_init_success)
//     {
//         Paint_DrawString_EN_CenterAtX(buf, SCREEN_WIDTH / 2, y + 2 * i2ctest_item_height + i2ctest_itemHeightOffset, nerrdev, &Font12, 1);
//     }
//     else if (device_init_success)
//     {
...
//         if (rate == -1)
//         {
//             snprintf(sps_str, sizeof(sps_str), "测试中");
//         }
//         else
//         {
//             snprintf(sps_str, sizeof(sps_str), "%luSPS", rate);
//         }

//         struct MPU6050_Data *md = get_mpu6050_data();
//         snprintf(data1, sizeof(data1), "%d", md ? md->accel_x : 0);
//         snprintf(data2, sizeof(data2), "%d", md ? md->accel_y : 0);
//         snprintf(data3, sizeof(data3), "%d", md ? md->accel_z : 0);
//         snprintf(data4, sizeof(data4), "%d", md ? md->gyro_x : 0);
//         snprintf(data5, sizeof(data5), "%d", md ? md->gyro_y : 0);
//         snprintf(data6, sizeof(data6), "%d", md ? md->gyro_z : 0);
//         snprintf(temp, sizeof(temp), "%.1fC", md ? md->temperature_c : 0.0f);

//         Paint_DrawString_EN(buf, x + 3, y + 1 * i2ctest_item_height + i2ctest_itemHeightOffset, temp, &Font12, 1);
//         Paint_DrawString_EN(buf, x + 3 + 6 * i2ctest_font_width, y + 1 * i2ctest_item_height + i2ctest_itemHeightOffset, sps_str, &Font12, 1);
//         Paint_DrawString_EN(buf, x + 3, y + 2 + 2 * i2ctest_item_height + i2ctest_itemHeightOffset, data1, &Font8, 1);
//         Paint_DrawString_EN(buf, x + 3 + 38, y + 2 + 2 * i2ctest_item_height + i2ctest_itemHeightOffset, data2, &Font8, 1);
//         Paint_DrawString_EN(buf, x + 3 + 76, y + 2 + 2 * i2ctest_item_height + i2ctest_itemHeightOffset, data3, &Font8, 1);
//         Paint_DrawString_EN(buf, x + 3, y + 3 * i2ctest_item_height + i2ctest_itemHeightOffset, data4, &Font8, 1);
//         Paint_DrawString_EN(buf, x + 3 + 38, y + 3 * i2ctest_item_height + i2ctest_itemHeightOffset, data5, &Font8, 1);
//         Paint_DrawString_EN(buf, x + 3 + 76, y + 3 * i2ctest_item_height + i2ctest_itemHeightOffset, data6, &Font8, 1);
//     }
//     else if (!device_init_success && !device_error_occurred)
//     {
//         Paint_DrawString_EN_CenterAtX(buf, SCREEN_WIDTH / 2, y + 2 * i2ctest_item_height + i2ctest_itemHeightOffset, nodev, &Font12, 1);
//     }
//     else if (device_error_occurred)
//     {
//         Paint_DrawString_EN_CenterAtX(buf, SCREEN_WIDTH / 2, y + 2 * i2ctest_item_height + i2ctest_itemHeightOffset, nerrdev, &Font12, 1);
...
//     // 右上角模式标注//////////////////////////////////////////////////////////////
//     // Paint_DrawString_EN(buf, 100, Ypos + 64 + 0, i2ctest_master_mode ? "Master" : "Monitor", &Font8, 1);
...
//         // 显示暂停标识
//         // Paint_DrawString_EN(buf, 100, Ypos + 64, "PAUSE", &Font8, 1);
//     }
//     else
//     {
//         // 非暂停时，使用当前时间计算进度条位置
...
//             break;
//         case 2: // DEMO 选择窗口
//             heighEND = i2ctest_item_height * 3;
//             widthEnd = i2ctest_ChangeVal_Width;
//             xEnd = (SCREEN_WIDTH - widthEnd) / 2;
//             yEnd = (SCREEN_HEIGHT - heighEND) / 2 + 1;
//             i2ctest_monitor_YPos_End = 0;
...
//             break;
//         case 5: // MPU6050 测试窗口
//             heighEND = i2ctest_item_height * 4 - 2;
//             widthEnd = 120;
//             xEnd = (SCREEN_WIDTH - widthEnd) / 2;
...
//         if (i2ctestIsRunning && !i2ctest_infunction && (nowselect_i2c_item == 4 || nowselect_i2c_item == 5))
//         { // 二级窗口选择器动画加速
...
//             if (i2ctest_monitor_but_need_draw_main || (!i2ctestIsRunning && nowselect_i2c_item != 3) || (i2ctestIsRunning && i2ctest_infunction) || (nowselect_i2c_item == 4 || nowselect_i2c_item == 5))
//             {
//                 draw_i2ctest_main(monitor_YPos);
//             }

//             if (nowselect_i2c_item == 4 || nowselect_i2c_item == 5)
//             {
//                 if (i2ctest_infunction)
//                 {
...
//             else if ((i2ctestIsRunning && !i2ctest_infunction))
//             {
//                 ApplyBlurEffect(buf, 1);
//             }
...
//                     break;
//                 case 2:
//                     draw_i2ctest_demo_selector();
//                     break;
//                 case 4:
//                     draw_ssd1306_testinfo();
//                     break;
//                 case 5:
//                     draw_mpu6050_testinfo();
...
//             if (nowselect_i2c_item == 3)
//             {
//                 // 监视器逻辑（参考 serialread：选中后先上滑）
//                 if (opnUp && !i2ctestIsRunning)
//                 {
//                     nowselect_i2c_item--;
//                     if (nowselect_i2c_item < 0)
//                         nowselect_i2c_item = 0;
//                 }
...
//                 else if (opnExit)
//                 {
//                     nowselect_i2c_item = i2ctest_select_temp; // 返回之前选择
//                 }
//                 else if (opnEnter)
//                 {
//                     i2c_monitor_paused = !i2c_monitor_paused; // 切换暂停状态
//                 }
//             }
//             else
//             {
...
//                             if (i2ctest_global_i2c_freq_selection < 0)
//                                 i2ctest_global_i2c_freq_selection = 0;
//                             i2ctest_temp_i2c_freq = i2ctest_preset_values[i2ctest_global_i2c_freq_selection];
//                         }
//                         else if (opnUp)
//                         {
//                             i2ctest_global_i2c_freq_selection++;
//                             if (i2ctest_global_i2c_freq_selection > 3)
//                                 i2ctest_global_i2c_freq_selection = 3;
//                             i2ctest_temp_i2c_freq = i2ctest_preset_values[i2ctest_global_i2c_freq_selection];
//                         }
//                         else if (opnEnter)
//                         {
//                             // 确认
//                             StartStateLED();
//                             i2c_freq = i2ctest_temp_i2c_freq; // 提交临时频率
//                             i2ctestIsRunning = false;
//                             // 已弃用 使用CORE1进行I2C监视并更新
//                             // test_configure_i2c_pins(i2c_freq,true);
...
//                         }
//                     }
//                     else if (nowselect_i2c_item == 2)
//                     {
//                         // DEMO 选择窗口
//                         if (opnUp)
//                         {
//                             i2ctest_demo_selection_index = 0;
//                         }
//                         else if (opnDown)
//                         {
//                             i2ctest_demo_selection_index = 1;
//                         }
//                         else if (opnEnter)
//                         {
//                             // 切换到对应测试窗口并启动 Core1 测试
//                             if (i2ctest_demo_selection_index == 0)
//                             {
//                                 start_core1_ssd1306_test(true);
//                                 nowselect_i2c_item = 4;
//                                 // i2ctest_infunction = 1;
//                             }
//                             else
//                             {
//                                 start_core1_mpu6050_test(true);
//                                 nowselect_i2c_item = 5;
//                                 // i2ctest_infunction = 1;
//                             }
//                         }
//                         if (opnExit)
...
//                         }
//                     }
//                     else if (nowselect_i2c_item == 4 || nowselect_i2c_item == 5)
//                     {
//                         // 测试窗口：仅处理退出
//                         if (opnExit)
//                         {
...
//                             i2ctestIsRunning = false;
//                             i2ctest_outfunction = 1;
//                             nowselect_i2c_item = 2; // 返回 DEMO 项
//                         }
//                     }
//                 }
//                 else
...
//                             i2ctest_monitor_but_need_draw_main = true;
//                     }
//                     else if (opnExit && nowselect_i2c_item != 3)
//                     {
//                         nowselect_i2c_item = 3;
//                         i2ctest_monitor_but_need_draw_main = true;
//                     }
//                     else if (opnEnter && nowselect_i2c_item != 3)
//                     {
//                         switch (nowselect_i2c_item)
//                         {
//                         case 0: // 交换 SCL/SDA
...
//                             sync_i2c_freq_selection_from_value();
//                             i2ctest_temp_i2c_freq = i2ctest_preset_values[i2ctest_global_i2c_freq_selection]; // 初始化临时频率
...
//                     }
//                     if (nowselect_i2c_item != 3)
//                         i2ctest_select_temp = nowselect_i2c_item;
//                 }
//             }
...
//             if (now - last_status_send_time >= 200)
//             {
//                 last_status_send_time = now;
//                 if (nowselect_i2c_item == 4)
//                 {
//                     extern void handle_pc_infotmation_ssddemo();
//                     handle_pc_infotmation_ssddemo(); // SSD1306
//                 }
//                 else if (nowselect_i2c_item == 5)
//                 {
//                     extern void handle_pc_infotmation_mpudemo();
//                     handle_pc_infotmation_mpudemo(); // MPU6050
//                 }
//             }
//         }
//     }
